...
import com.rts.availoffers.product.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.rts.availoffers.product.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getThirdpartyid() != null) {
                    existingProduct.setThirdpartyid(product.getThirdpartyid());
                }
                if (product.getUniversalcode() != null) {
                    existingProduct.setUniversalcode(product.getUniversalcode());
                }
                ...
                if (product.getNoofstock() != null) {
                    existingProduct.setNoofstock(product.getNoofstock());
                }
